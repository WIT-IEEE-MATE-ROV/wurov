# currently not working with imu_9d msg
# #! DEPRECATED
...
# import rospy
# from wurov.msg import imu_9d, trajectory
...
#     rospy.Subscriber('imu_9d_filtered', imu_9d, callback_imu_9d)
